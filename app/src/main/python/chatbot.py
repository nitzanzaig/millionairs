...
def load_data(data):
    try:
        with open('data/english_labels_list.json', 'r') as labels_file, open('data/english_pattern_vocab.json', 'r') as pattern_file:
...
def main(message):
    ...
    try:
        ...
        loaded_model = keras.models.load_model("keras_models/english_model.h5")
        ...
        model.save("keras_models/english_model.h5")
